...
TOKEN = (
    os.environ.get("8371417905:AAF7Dw68NbAfdgdVkHLuf06M4-GJQsYdmj8")
    or os.environ.get("8371417905:AAF7Dw68NbAfdgdVkHLuf06M4-GJQsYdmj8")
    or os.environ.get("8371417905:AAF7Dw68NbAfdgdVkHLuf06M4-GJQsYdmj8")
    or BOT_TOKEN_HARDCODED
    or ""
).strip()
try:
    OWNER_ID = int(os.environ.get("OWNER_ID", "1630422629"))
...
ANNOUNCE_CHANNEL = os.environ.get("https://t.me/KD19481", "").strip()
try:
    KEEPALIVE_PORT = int(os.environ.get("PORT", 10460))
except (TypeError, ValueError):
    KEEPALIVE_PORT = 10000

BRAND       = "ᴋᴅ нoѕтιηg ΒOT"
BRAND_VER   = "2.0"
BRAND_TAG   = f"{BRAND} {BRAND_VER}"
SUPPORT_USR = "@KD1948"
UPDATE_CH   = "https://t.me/KD19481"
